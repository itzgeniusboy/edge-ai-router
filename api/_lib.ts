// Shared serverless-safe helpers — ZERO dependencies (express/ws NOT imported).
// NOTE: getRouterOperatorInstruction mirrors server.ts (same prompt text).
// If you update the prompt, update both places.

export function resolvePublicUserKey(req: any): string {
...
export async function getGenAIClient(customApiKey?: string): Promise<any> {
...
export function getRouterOperatorInstruction(state?: any): string {
